...
class GroupBy extends Twig_Extension {
    ...
    public function groupBy($collection, $group_attr, $format = null, $timezone = null, $date = false) {
        ...
        foreach ($collection as $entity) {
            ...
            $key = 'Unknown';
            $attr = $this->getAttribute($entity, $group_attr);

            if(null !== $format) {
                $key = (is_string($format)) 
                            ? twig_date_format_filter($attr, $format, $timezone)
                            : $key = (null !== $attr);
